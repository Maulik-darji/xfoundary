...
const CoFounderMatching = () => {
    ...
    return (
        <div style={{ backgroundColor: '#fff', fontFamily: '"Inter", sans-serif', color: '#111' }}>
            {/* Hero Section */}
            <section style={{ backgroundColor: '#f6f6ef', padding: '6rem 2rem' }}>
                <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'flex', alignItems: 'center', gap: '4rem' }}>
                    ...
                    <div style={{ flex: 0.8, position: 'relative', height: '350px' }}>
                        {/* Overlapping circles simulation */}
                        {[
            ...
            {/* USP Section */}
            <section style={{ padding: '6rem 2rem', borderBottom: '1px solid #eee' }}>
                <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
                    <h2 style={{ fontSize: '28px', fontWeight: '900', marginBottom: '1.5rem', maxWidth: '800px', lineHeight: '1.3' }}>
            ...
            <section style={{ backgroundColor: '#f6f6ef', padding: '6rem 2rem' }}>
                <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                    <h2 style={{ fontSize: '32px', fontWeight: '900', marginBottom: '3rem' }}>How does it work?</h2>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                        {[
                            ...
                            <div key={s.step} style={{ display: 'flex', alignItems: 'center', gap: '2rem' }}>
                                <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: '#f1f1e8', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '14px', fontWeight: '700', flexShrink: 0 }}>{s.step}</div>
                                <div style={{ fontSize: '18px', fontWeight: '500', color: '#111' }}>{s.text}</div>
                            </div>
                        ))}
                    </div>
                </div>
